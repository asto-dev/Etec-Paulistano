  ...
  return (
    ...
    >
      <main className="flex flex-col  w-[53rem] ml-12 mt-20">
        ...
        <p className="text-white break-words text-3xl my-8">Onde o conhecimento transforma vidas e o futuro é construído com dedicação. Oferecemos formação de excelência com professores qualificados. Venha transformar sua carreira!</p>
